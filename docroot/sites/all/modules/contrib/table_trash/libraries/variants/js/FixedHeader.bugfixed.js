 ...
 * o replace one occurrence of $() by jQuery()
 * o checks for null/undefined
 */
...
FixedHeader.prototype = {
	...
	fnInit: function ( oTable, oInit )
	{
		...
		if ( typeof oTable.fnSettings == 'function' )
		{
			...
			// RdeBoer: added null check
			if ( !oDtSettings || oDtSettings.oScroll.sX != "" || oDtSettings.oScroll.sY != "" )
			{
				alert( "FixedHeader 2 is not supported with <tfoot> or DataTables' scrolling mode at this time" );
				return;
			}
