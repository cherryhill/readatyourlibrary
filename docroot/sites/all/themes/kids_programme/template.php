...
**/
//function kids_programme_preprocess_html(&$variables) {
 ...
 *
 */
//function kids_programme_preprocess_node(&$variables) {
//}

/**
 * Implements hook_preprocess_block()
 */
//function kids_programme_preprocess_block(&$variables) {
...
//function kids_programme_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function kids_programme_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function kids_programme_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function kids_programme_form_element_label($variables) {
 ...
 */
//function kids_programme_preprocess_button(&$variables) {
 ...
 */
//function kids_programme_form_alter(&$form, &$form_state, $form_id) {
//  // Sexy submit buttons
 ...
 */
//function kids_programme_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
function kids_programme_css_alter(&$css) {
  if (isset($css[drupal_get_path('theme', 'kids_programme') . '/css/custom.css'])) {
    $css[drupal_get_path('theme', 'kids_programme') . '/css/custom.css']['group'] += 1;
  }
 ...
 */
// function kids_programme_js_alter(&$js) {
...
function kids_programme_breadcrumb($variables) {
  global $base_url;
