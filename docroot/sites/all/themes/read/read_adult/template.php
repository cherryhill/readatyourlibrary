...
**/
//function read_adult_preprocess_html(&$variables) {
 ...
 *
 */
//function read_adult_preprocess_page(&$variables) {
//}
 ...
 *
 */
//function read_adult_preprocess_node(&$variables) {
//}

/**
 * Implements hook_preprocess_block()
 */
//function read_adult_preprocess_block(&$variables) {
...
//function read_adult_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function read_adult_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function read_adult_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function read_adult_form_element_label($variables) {
 ...
 */
//function read_adult_preprocess_button(&$variables) {
 ...
 */
//function read_adult_form_alter(&$form, &$form_state, $form_id) {
//  // Sexy submit buttons
 ...
 */
//function read_adult_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
function read_adult_css_alter(&$css) {
  if (isset($css[drupal_get_path('theme', 'read_adult') . '/css/custom.css'])) {
    $css[drupal_get_path('theme', 'read_adult') . '/css/custom.css']['group'] += 1;
  }
 ...
 */
// function read_adult_js_alter(&$js) {
...
function read_adult_menu_breadcrumb_alter(&$breadcrumb) {
