...
**/
//function kids_program_preprocess_html(&$variables) {
 ...
 *
 */
//function kids_program_preprocess_page(&$variables) {
//}
 ...
 *
 */
//function kids_program_preprocess_node(&$variables) {
//}

/**
 * Implements hook_preprocess_block()
 */
//function kids_program_preprocess_block(&$variables) {
...
//function kids_program_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function kids_program_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function kids_program_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function kids_program_form_element_label($variables) {
 ...
 */
//function kids_program_preprocess_button(&$variables) {
 ...
 */
//function kids_program_form_alter(&$form, &$form_state, $form_id) {
//  // Sexy submit buttons
 ...
 */
//function kids_program_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
function kids_program_css_alter(&$css) {
  if (isset($css[drupal_get_path('theme', 'kids_program') . '/css/custom.css'])) {
    $css[drupal_get_path('theme', 'kids_program') . '/css/custom.css']['group'] += 1;
  }
 ...
 */
// function kids_program_js_alter(&$js) {
...
function kids_program_menu_breadcrumb_alter(&$breadcrumb) {
