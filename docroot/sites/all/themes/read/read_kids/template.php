...
**/
//function read_kids_preprocess_html(&$variables) {
 ...
 *
 */
//function read_kids_preprocess_page(&$variables) {
//}
 ...
 *
 */
//function read_kids_preprocess_node(&$variables) {
//}

/**
 * Implements hook_preprocess_block()
 */
//function read_kids_preprocess_block(&$variables) {
...
//function read_kids_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function read_kids_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function read_kids_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function read_kids_form_element_label($variables) {
 ...
 */
//function read_kids_preprocess_button(&$variables) {
 ...
 */
//function read_kids_form_alter(&$form, &$form_state, $form_id) {
//  // Sexy submit buttons
 ...
 */
//function read_kids_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
function read_kids_css_alter(&$css) {
  if (isset($css[drupal_get_path('theme', 'read_kids') . '/css/custom.css'])) {
    $css[drupal_get_path('theme', 'read_kids') . '/css/custom.css']['group'] += 1;
  }
 ...
 */
// function read_kids_js_alter(&$js) {
...
function read_kids_menu_breadcrumb_alter(&$breadcrumb) {
