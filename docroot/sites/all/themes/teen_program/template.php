...
**/
//function teen_program_preprocess_html(&$variables) {
 ...
 *
 */
//function teen_program_preprocess_page(&$variables) {
//}
 ...
 *
 */
//function teen_program_preprocess_node(&$variables) {
//}
...
//function teen_program_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function teen_program_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function teen_program_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function teen_program_form_element_label($variables) {
 ...
 */
//function teen_program_preprocess_button(&$variables) {
 ...
 */
//function teen_program_form_alter(&$form, &$form_state, $form_id) {
//  // Sexy submit buttons
 ...
 */
//function teen_program_form_comment_form_alter(&$form, &$form_state) {
...
function teen_program_breadcrumb($variables) {
  global $base_url;
 ...
 */
function teen_program_css_alter(&$css) {
  if (isset($css[drupal_get_path('theme', 'teen_program') . '/css/custom.css'])) {
    $css[drupal_get_path('theme', 'teen_program') . '/css/custom.css']['group'] += 1;
  }
 ...
 */
// function teen_program_js_alter(&$js) {
