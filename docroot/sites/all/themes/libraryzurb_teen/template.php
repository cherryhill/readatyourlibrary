...
**/
//function libraryzurb_teen_preprocess_html(&$variables) {
 ...
 *
 */
//function libraryzurb_teen_preprocess_page(&$variables) {
//}
 ...
 *
 */
//function libraryzurb_teen_preprocess_node(&$variables) {
//}

/**
 * Implements hook_preprocess_block()
 */
//function libraryzurb_teen_preprocess_block(&$variables) {
...
//function libraryzurb_teen_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function libraryzurb_teen_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function libraryzurb_teen_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function libraryzurb_teen_form_element_label($variables) {
 ...
 */
//function libraryzurb_teen_preprocess_button(&$variables) {
 ...
 */
//function libraryzurb_teen_form_alter(&$form, &$form_state, $form_id) {
//  // Sexy submit buttons
 ...
 */
//function libraryzurb_teen_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
function libraryzurb_teen_css_alter(&$css) {
  if (isset($css[drupal_get_path('theme', 'libraryzurb_teen') . '/css/custom.css'])) {
    $css[drupal_get_path('theme', 'libraryzurb_teen') . '/css/custom.css']['group'] += 1;
  }
 ...
 */
// function libraryzurb_teen_js_alter(&$js) {
