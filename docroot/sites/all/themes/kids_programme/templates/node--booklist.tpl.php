...
<div class="book-review-page-overlay">
  <div class="booklist-title">
    <div class="bk_title">
      ...
      <div class="booklist_creator"><div class = "created"><?php if ($privacy_field == 'public' || $privacy_field == 'private'){ print 'Created by'; }?></div><div class="avatar"><?php if ($privacy_field == 'public' || $privacy_field == 'private') { print $img; } ?></div><div class ="name_author"><?php if ($privacy_field == 'public' || $privacy_field == 'private'){ print "<a href = '$base_url/users/public_profile/$node_uid' class = 'user_profile_node'>".$booklist_creator.'</a>'; } ?></div></div>
    </div>
  ...
  <article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
   ...
   <!-- Display according to user privacy setting -->
    ...
    <div class="reviewbook_footer"><?php print render($content['links']); ?></div>
