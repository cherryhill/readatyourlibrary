...
**/
//function teen_programme_preprocess_html(&$variables) {
 ...
 *
 */
//function teen_programme_preprocess_node(&$variables) {
//}

/**
 * Implements hook_preprocess_block()
 */
//function teen_programme_preprocess_block(&$variables) {
...
//function teen_programme_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function teen_programme_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function teen_programme_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function teen_programme_form_element_label($variables) {
 ...
 */
//function teen_programme_preprocess_button(&$variables) {
 ...
 */
//function teen_programme_form_alter(&$form, &$form_state, $form_id) {
//  // Sexy submit buttons
 ...
 */
//function teen_programme_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
function teen_programme_css_alter(&$css) {
  if (isset($css[drupal_get_path('theme', 'teen_programme') . '/css/custom.css'])) {
    $css[drupal_get_path('theme', 'teen_programme') . '/css/custom.css']['group'] += 1;
  }
 ...
 */
// function teen_programme_js_alter(&$js) {
...
function teen_programme_menu_breadcrumb_alter(&$breadcrumb) {
  if (!empty($breadcrumb)) { 
