...
function teen_preprocess_block(&$variables) {
...
function teen_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function teen_css_alter(&$css) {
  if (isset($css[drupal_get_path('theme', 'teen') . '/css/custom.css'])) {
    $css[drupal_get_path('theme', 'teen') . '/css/custom.css']['group'] += 1;
  }
