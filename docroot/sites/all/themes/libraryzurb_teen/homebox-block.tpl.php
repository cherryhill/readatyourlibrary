...
//Block Name according thier respective view.

if (isset($block->content['#views_contextual_links_info'])) {
  $human_nm = $block->content['#views_contextual_links_info']['views_ui']['view']->human_name;
}else {
  $human_nm = $block->subject;
}
...
<div id="homebox-block-<?php print $block->key; ?>" class="<?php print $block->homebox_classes ?> clearfix block block-<?php print $block->module ?>">
  <div class="homebox-portlet-inner">
    <h3 class="portlet-header">
      ...
      <?php endif; ?>
      <span class="portlet-title"><?php print $human_nm; //$block->subject ?></span>
    </h3>
