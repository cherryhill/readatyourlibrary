...
**/
//function read_teen_preprocess_html(&$variables) {
 ...
 *
 */
//function read_teen_preprocess_page(&$variables) {
//}
 ...
 *
 */
//function read_teen_preprocess_node(&$variables) {
//}

/**
 * Implements hook_preprocess_block()
 */
//function read_teen_preprocess_block(&$variables) {
...
//function read_teen_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function read_teen_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function read_teen_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function read_teen_form_element_label($variables) {
 ...
 */
//function read_teen_preprocess_button(&$variables) {
 ...
 */
//function read_teen_form_alter(&$form, &$form_state, $form_id) {
//  // Sexy submit buttons
 ...
 */
//function read_teen_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
function read_teen_css_alter(&$css) {
  if (isset($css[drupal_get_path('theme', 'read_teen') . '/css/custom.css'])) {
    $css[drupal_get_path('theme', 'read_teen') . '/css/custom.css']['group'] += 1;
  }
 ...
 */
// function read_teen_js_alter(&$js) {
...
function read_teen_menu_breadcrumb_alter(&$breadcrumb) {
